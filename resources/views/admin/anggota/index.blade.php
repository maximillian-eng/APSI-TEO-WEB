...
<div class="bg-white dark:bg-gray-800 rounded-lg shadow">
    <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <a href="{{ route('admin.anggota.create') }}" class="px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 text-sm font-medium text-center whitespace-nowrap">
            + Daftarkan Anggota
        </a>
    </div>
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                    ...
                    <td class="px-6 py-4 text-right space-x-2">
                        <a href="{{ route('admin.anggota.edit', $anggota) }}" class="text-indigo-600 hover:text-indigo-800 dark:text-indigo-400 text-xs">Edit</a>
