            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="biografi" id="biografi" rows="4" required
                              class="mt-1 block w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('biografi', $pengarang->biografi) }}</textarea>
