<x-guest-layout>
    <form method="POST" action="{{ route('register') }}" class="space-y-5">
        ...
        <div>
            <label for="nama" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1.5">Nama Lengkap</label>
            <div class="relative">
    ...
    <div class="mt-6 text-center">
        <p class="text-sm text-gray-500 dark:text-gray-400">
            Sudah punya akun?
            <a href="{{ route('login') }}" class="font-semibold text-amber-700 dark:text-amber-400 hover:text-amber-800 dark:hover:text-amber-300 transition">Masuk</a>
        </p>
    </div>
</x-guest-layout>
