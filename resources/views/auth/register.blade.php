<x-guest-layout>
    <form method="POST" action="{{ route('register') }}" class="space-y-5">
        ...
        <div>
            <label for="nama" class="block text-sm font-semibold text-amber-900 mb-1.5">Nama Lengkap</label>
            <div class="relative">
                <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                    <svg class="w-5 h-5 text-amber-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z"/></svg>
                </div>
        ...
        <div>
            <label for="password_confirmation" class="block text-sm font-semibold text-amber-900 mb-1.5">Konfirmasi Password</label>
            <div class="relative">
                <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
    ...
    <div class="mt-6 text-center">
        <p class="text-sm text-amber-600/70">
            Sudah punya akun?
            <a href="{{ route('login') }}" class="font-semibold text-amber-800 hover:text-amber-900 transition underline">Masuk</a>
        </p>
    </div>
</x-guest-layout>
